...
req.open("GET","https://api.nasa.gov/planetary/apod? api_key = QtWcCMyqJfEfHQjkezj0InUGmMlBQhCwSc3wOcTP"
);
...
submitRequest.addEventListener("click", function () {
	...
	let urlNewReq = `https://api.nasa.gov/planetary/apod?api_key=QtWcCMyqJfEfHQjkezj0InUGmMlBQhCwSc3wOcTP&date=${inputedDate.value}`;
